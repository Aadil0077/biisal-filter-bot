...
USERNAME = environ.get('USERNAME', "https://t.me/M_HRequest")
...
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/ccb9db43e2e524928e.jpg')
START_IMG = environ.get('START_IMG', 'https://telegra.ph/file/e136075c7c2443f86716d.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002019824318'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002019824318'))
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Movie_Url_link_dwnloaer/17")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "7SoRin98O4Z8veQDs4MOmlz6Jge2")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'http://shareus.io')
SHORTENER_API2 = environ.get("SHORTENER_API2", "7SoRin98O4Z8veQDs4MOmlz6Jge2")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'http://shareus.io')
SHORTENER_API3 = environ.get("SHORTENER_API3", "7SoRin98O4Z8veQDs4MOmlz6Jge2")
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", 'http://shareus.io')
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002019824318')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002019824318'))
